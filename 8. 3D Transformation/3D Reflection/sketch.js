...
function draw(){
    ...
    a1 = mat_multi(y_axis,a);
    b1 = mat_multi(y_axis,b);
    c1 = mat_multi(y_axis,c);
    d1 = mat_multi(y_axis,d);
    e1 = mat_multi(y_axis,e);
    f1 = mat_multi(y_axis,f);
    g1 = mat_multi(y_axis,g);
    h1 = mat_multi(y_axis,h);
